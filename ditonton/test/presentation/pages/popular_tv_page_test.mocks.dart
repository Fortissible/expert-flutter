...
class MockTvListNotifier extends _i1.Mock implements _i5.TvListNotifier {
  ...
  @override
  _i6.RequestState get nowPlayingState => (super.noSuchMethod(
        Invocation.getter(#nowPlayingState),
        returnValue: _i6.RequestState.Empty,
      ) as _i6.RequestState);

  @override
  List<_i7.Tv> get nowPlayingTv => (super.noSuchMethod(
        Invocation.getter(#nowPlayingTv),
        returnValue: <_i7.Tv>[],
      ) as List<_i7.Tv>);

  @override
  String get nowPlayingErrorMsg => (super.noSuchMethod(
        Invocation.getter(#nowPlayingErrorMsg),
  ...
  @override
  _i6.RequestState get popularState => (super.noSuchMethod(
  ...
  @override
  String get popularErrorMsg => (super.noSuchMethod(
        Invocation.getter(#popularErrorMsg),
        returnValue: _i8.dummyValue<String>(
          this,
          Invocation.getter(#popularErrorMsg),
        ),
  ...
  @override
  _i6.RequestState get topRatedState => (super.noSuchMethod(
  ...
  @override
  String get topRatedErrorMsg => (super.noSuchMethod(
        Invocation.getter(#topRatedErrorMsg),
        returnValue: _i8.dummyValue<String>(
          this,
          Invocation.getter(#topRatedErrorMsg),
        ),
  ...
  @override
  _i9.Future<void> fetchNowPlayingTv() => (super.noSuchMethod(
        Invocation.method(
          #fetchNowPlayingTv,
          [],
        ),
