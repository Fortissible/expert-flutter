...
void main() {
  ...
  group('get Popular Movies', () {
    ...
    test('should return list of movies when response is success (200)',
        () async {
      // arrange
      when(mockDio.get('$BASE_URL/movie/popular?$API_KEY'))
          .thenAnswer((_) async =>
              Response(
                  requestOptions: RequestOptions(),
  ...
  group('get Top Rated Movies', () {
    ...
    test('should return list of movies when response code is 200 ', () async {
      // arrange
      when(mockDio.get('$BASE_URL/movie/top_rated?$API_KEY'))
          .thenAnswer((_) async =>
              Response(
                  requestOptions: RequestOptions(),
  ...
  group('get movie detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      // arrange
      when(mockDio.get('$BASE_URL/movie/$tId?$API_KEY'))
          .thenAnswer((_) async =>
              Response(
                  requestOptions: RequestOptions(),
  ...
  group('get movie recommendations', () {
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      // arrange
      when(mockDio
              .get('$BASE_URL/movie/$tId/recommendations?$API_KEY'))
          .thenAnswer((_) async => Response(
          requestOptions: RequestOptions(),
  ...
  group('search movies', () {
    ...
    test('should return list of movies when response code is 200', () async {
      // arrange
      when(mockDio
              .get('$BASE_URL/search/movie?$API_KEY&query=$tQuery'))
          .thenAnswer((_) async => Response(
          requestOptions: RequestOptions(),
